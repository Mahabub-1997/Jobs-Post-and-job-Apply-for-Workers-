        ...
        <div class="col-md-8 py-5 mx-auto">
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('privacy.update', $policy->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div id="sub-items">
                                @if(old('sub_title'))
                                    ...
                                    @endforeach
                                @elseif($policy->content)
                                    @foreach($policy->content as $item)
                                        <div class="sub-item mb-2">
                                            <input type="text" name="sub_title[]" class="form-control mb-1" value="{{ $item['subtitle'] ?? '' }}" placeholder="Sub Title" required>
                        ...
                        <button type="submit" class="btn btn-success mt-3">Update Privacy Policy</button>
                    </form>
                </div>
            </div>
        </div>
